...
const DEAL_COLUMNS = "deal_id, employee_id, store_id, deal_number, stock_number, rep, contract_date, status, stock_type, customer, vehicle, front_gross, rep_unit_count, rep_commission, spiffs, total_enhancers, trade_spiffs, is_split_deal, salesperson, dealer, make";
