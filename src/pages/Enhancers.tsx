  ...
  return (
    <>
      ...
      <main className="page">
        ...
        <div className="section-head"><h2>Rules for {monthLabel(month)}</h2><span className="count">{rules.length} rule(s)</span></div>
        {canEdit && drafts == null && (
        ...
        <div className="section-head"><h2>Priority list</h2><span className="count">{stocks.length} stock number(s)</span></div>
